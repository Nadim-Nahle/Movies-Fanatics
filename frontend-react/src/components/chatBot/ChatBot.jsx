...
const ChatBot = () => {
  ...
  // console.log(dateTime);
    ...
    let welcome = ['Sup|sup|Hello|Hi|hello|hi|Hi|Yo|yo|Halla|halla|yello|yelow']
    ...
    if(words7.test(document.querySelector('#input').value)){
      botMessage.innerHTML = 'Typing...';
      setTimeout(() => {
        botMessage.innerHTML = 'please choose a movie from the list(minions, doctor strange, jurassic world, thor, sonic, spider-man, dog, the lost city, morbius';
        document.querySelector('#input').value = '';
      }, 2000);
    }

    let movies =["Dog|scream|thor|minions|doctor-strange|jurassic|world|thor|sonic|spider-man|dog|the-lost-city|morbius"]
    ...
    if(words10.test(document.querySelector('#input').value)){
      botMessage.innerHTML = 'Typing...';
      setTimeout(() => {
        botMessage.innerHTML = 'nadim is a programmer based on ReactJS and NodeJS ';
        document.querySelector('#input').value = '';
      }, 2000);
    }
